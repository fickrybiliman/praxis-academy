...
public class VendingMachineImpl implements VendingMachine {
   ...
   private Item collectItem() throws NotSufficientChangeException, NotNullPaidException {
      if(isFullPaid()) {
      ...
      throw new NotNullPaidException("Price not fully paid, remaining : ", remainingBalance);
   }
